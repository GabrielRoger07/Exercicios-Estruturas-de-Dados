...
void divide_lista(celula *l, celula *l1, celula *l2){
    ...
    while(l != NULL){
        //printf("receba\n");
        if(l->dado%2==0){
            //Se entrou aqui, l tem que ir pra l2
            l2->prox = l;
            //l2->prox->prox = NULL;
            l2 = l2->prox;
            ...
            //Se entrou aqui, l tem que ir pra l1
            l1->prox = l;
            l1 = l1->prox;
        }
        //Verifica se é a ultima vez que o loop está rodando
        if(l ->prox == NULL){
            if(l->dado%2!=0){
                //Se o ultimo numero for impar, o proximo numero da lista par(ultimo) recebe null
                l2->prox = NULL;
            }else{
                //Se o ultimo numero for par, o proximo numero da lista impar(ultimo) recebe null
                l1->prox = NULL;
            }
        }
        //Avança o l
...
//As listas precisam estar ordenadas
